 ...
 var BatchSchema = mongoose.model('BatchSchema', {
     ...
     batchTeacherID: {type: String},
     batchTeacherName: {type: String},
     batchProjectManagerID: {type: String},
     batchProjectManagerName: {type: String},
