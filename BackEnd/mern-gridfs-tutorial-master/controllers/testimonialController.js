 ...
 router.post('/create', (req, res) => {
   console.log("Api hit")
     var emp = new Testimonial({
        ...
        testimonialAnswer: req.body.testimonialAnswer,
...
*/
 router.post("/:id", (req, res) => {
    ...
    Testimonial.findById(id, (err, testimonial) => {
      if (!testimonial) {
        ...
        testimonial.teacherName = req.body.teacherName;
        testimonial.referenceName = req.body.referenceName;
        testimonial.studentName = req.body.studentName;
        testimonial.studentID = req.body.studentID;
        testimonial.studentEmail = req.body.studentEmail;
        testimonial.status = req.body.status;
        testimonial.testimonialAnswer = req.body.testimonialAnswer;
        testimonial
          .save()
          .then((testimonial) => {
            res.json(testimonial);
 ...
 router.post("/specific/:id", (req, res) => {
  console.log("test")
  const id = req.params.id;
  Testimonial.find({ "teacherID" : id} , (err, student) => {
    res.json(student);
  });
}); 


router.post("/specific/student/:id", (req, res) => {
  console.log("test")
  const id = req.params.id;
  Testimonial.find({ "studentID" : id} , (err, student) => {
    res.json(student);
  });
}); 
