...
function CreateNotificationsForTeacher() {
  ...
  const log = (data) => {
      if (editorRef.current) {
        data.testimonialAnswer = editorRef.current.getContent({ format: "text" });
  ...
  const onSubmit = async (data) => {
    ...
    const formik = useFormik({
        initialValues: {
           ...
           referenceName: location.state.referenceName,
        ...
        validate: values => {
            ...
            if(!values.testimonialTitle){
                errors.testimonialTitle = "Please enter your Notification's Title"
              ...
              <div className="card-body">
                ...
                <div className = "mt-4">
                    ...
                    <div className = "mt-4">
                        ...
                        <div class="p-3 mb-2 bg-light text-dark">
                        {location.state.testimonialContent}
                        </div>
                        <hr />
                    </div>
            ...
            <div className="card align-middle justify-content-center m-auto shadow-sm  col-xl-10 col-lg-9 col-md-8  border-0 mb-4 text-center">
              ...
              <div className="card-body">
                ...
                <form onSubmit={formik.handleSubmit}>
                        ...
                        {location.state.testimonialAnswer != "" ? 
                        <Editor
                                                apiKey='zbxzyzqkm6uw6oz4uywxx4kbvw59xasjkldmya07y0hfjupf'
                                                onInit={(evt, editor) => editorRef.current = editor}
                                                initialValue = {location.state.testimonialAnswer}
                                                init={{
                                                height: 500,
