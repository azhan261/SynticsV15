    ...
    return (
        ...
        <div id="content">
          ...
          <div className="containerBlackDashboard-fluid mt-5">
            {/* Page Heading */}
            <h1 className='text-center display-4 my-3' style={{ color:'rgba(55, 64, 85, 0.9)', fontWeight:'900' }}>Edit Blog</h1>
            {/* DataTales Example */}
            <div className="card align-middle justify-content-center m-auto shadow-sm  col-xl-10 col-lg-9 col-md-8  border-0 mb-4 text-center">
              <div className="my-3" style = {{color : "rgba(55, 64, 85, 0.9)"}}>
                <h5 className="mb-2 lead display-5 text-center" style={{ color:'rgba(55, 64, 85, 0.9)', fontWeight:'900' }}>Blog</h5>
              </div>
              <div className="card-body">
                ...
                <form onSubmit={formik.handleSubmit}>
                        ...
                        <center>
                        <div >
                                  <button className="btn m-2 shadow-sm  btn-outline-muted" type = "submit" style = {{fontWeight : "bold" }} >
                                    Save Changes
                                  </button>
                                </div>
                        </center>
