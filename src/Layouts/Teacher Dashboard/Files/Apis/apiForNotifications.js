...
export const getNotificationSpecific = id => (
	console.log(id),
	axios.post(`https://syntics.co/testimonials/specific/${id}`)
		.then(res => res.data, )
)
export const updateNotification = (todo, id) => fetch(`https://syntics.co/testimonials/${id}`, {
  method: "POST",
  headers: {
    "Accept": "application/json",
    "Content-Type": "application/json"
...
export const getNotificationSpecificTeacher = (id) => (
	console.log(id),
