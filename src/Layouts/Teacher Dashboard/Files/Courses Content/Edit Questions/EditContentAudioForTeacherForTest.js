  ...
  <div className="containerBlackDashboard-fluid mt-5">
    ...
    <div className="card align-middle justify-content-center m-auto shadow-sm  col-xl-10 col-lg-9 col-md-8  border-0 mb-4 text-center">
      <div className="my-3" style = {{color : "rgba(55, 64, 85, 0.9)"}}>
        <h5 className="mb-2 lead display-5 text-center" style={{ color:'rgba(55, 64, 85, 0.9)', fontWeight:'900' }}> Course Q/A Test Edit Panel</h5>
      </div>
      ...
      <form onSubmit={formik.handleSubmit}>
                  ...
                  <div className = "mt-4"> 
                      <div className="p-3 mb-2 " style = {{color : "white", backgroundColor : "rgba(55, 64, 85, 0.9)"}}>
                          <label><h5 className = "text-white">Please edit your desired <b>Audio</b> Question below</h5></label>
                      </div>
                      <div className="p-3 mb-2 bg-light text-dark">
