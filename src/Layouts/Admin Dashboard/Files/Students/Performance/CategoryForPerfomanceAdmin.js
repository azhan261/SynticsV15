...
import {BrowserRouter as Router, Switch, Link, Route, useHistory, useParams, useLocation, } from 'react-router-dom' 
import { CDBBtn, CDBContainer } from "cdbreact";
//import "../../../ResultCategory.scss"

function CategoryForPerfomanceAdmin() {
    let {id} = useParams()
    ...
    const onSubjectClick = (e) => {
      e.preventDefault(e)
      history.push({
        pathname:`/admin/studentPerformance/${id}`,
    ...
    const onTestClick = (e) => {
      e.preventDefault(e)
      history.push({
        pathname:`/admin/studentPerformance-test/${id}`,
        state:location.state 
      })
    }
    ...
    const onAssignmentClick = (e) => {
      e.preventDefault(e)
      history.push({
        pathname: `/admin/studentPerformance-assignment/${id}`,
        state: location.state
      })
    }
      return (
...
export default CategoryForPerfomanceAdmin
