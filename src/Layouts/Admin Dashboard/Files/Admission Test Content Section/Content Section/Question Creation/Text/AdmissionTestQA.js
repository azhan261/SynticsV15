          ...
          <Col md="12">
            <Card className="card-plain">
              ...
              <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className = "mt-4"> 
                        <div class="p-3 mb-2 bg-dark text-white">
                            <label ><h5 className="mb-2 lead display-5 text-center" style={{ color:'rgba(55, 64, 85, 0.9)', fontWeight:'900' }}>Please create your desired <b>Q/A</b> Question below</h5></label>
                        </div>
                        <div class="p-3 mb-2 bg-light text-dark">
                          <Editor
