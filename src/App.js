...
import PaymentDetails from './Layouts/Admin Dashboard/Files/Payments/PaymentDetails';
import CreatePaymentRecord from './Layouts/Admin Dashboard/Files/Payments/CreatePaymentRecord';
import UpdatePayment from './Layouts/Admin Dashboard/Files/Payments/UpdatePayment';

import PerfomanceAdmin from './Layouts/Admin Dashboard/Files/Students/Performance/PerfomanceAdmin';
import PerfomanceForAssignmentAdmin from './Layouts/Admin Dashboard/Files/Students/Performance/PerfomanceForAssignmentAdmin';
import PerformanceForTestAdmin from './Layouts/Admin Dashboard/Files/Students/Performance/PerformanceForTestAdmin';
import CategoryForPerfomanceAdmin from './Layouts/Admin Dashboard/Files/Students/Performance/CategoryForPerfomanceAdmin';

import ResultsForStudentAdmin from './Layouts/Admin Dashboard/Files/Students/Results/Results';
import ResultsCategoryForStudentsAdmin from './Layouts/Admin Dashboard/Files/Students/Results/ResultCategoryForStudents';
import ResultsForTestForStudentsAdmin from './Layouts/Admin Dashboard/Files/Students/Results/ResultsForTest';
    ...
    <Router>
        <Switch>
          ...
          <Route path="/abc" component={CheckingNavBar} />
           ...
           <AdminDashboardLayout path="/admin/results-category-students/:id" component={ResultsCategoryForStudentsAdmin} />
           <AdminDashboardLayout path="/admin/answer-list/:id" component={ResultsForStudentAdmin} />
           <AdminDashboardLayout path="/admin/answer-list-test/:id" component={ResultsForTestForStudentsAdmin} />
           ...
           <AdminDashboardLayout path="/admin/student-payments/:id" component={PaymentDetails} />
           <AdminDashboardLayout path="/admin/create-payment-record/:id" component={CreatePaymentRecord} />
           <AdminDashboardLayout path="/admin/update-payment-record/:id" component={UpdatePayment} />
           
           <AdminDashboardLayout path="/admin/studentPerformance/:id" component={PerfomanceAdmin} /> 
           <AdminDashboardLayout path="/admin/studentPerformance-test/:id" component={PerformanceForTestAdmin} /> 
           <AdminDashboardLayout path="/admin/studentPerformance-assignment/:id" component={PerfomanceForAssignmentAdmin} /> 
           <AdminDashboardLayout path="/admin/category-for-performance/:id" component={CategoryForPerfomanceAdmin} /> 
