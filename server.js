...
app.use(cors({ origin: [  'http://localhost:3000','htpp://localhost:3001','http://localhost:3002','http://localhost:3003','http://localhost:3004','http://localhost:3005',
                          ...
                          'https://syntics.co', 'https://syntics.co/', 'http://syntics.co', 'http:18.219.48.208:9000', 'https:18.219.48.208:9000', 
						  'http:18.219.48.208', 'https:18.219.48.208'  ]}));
*/

app.use(function (req, res,) {

	// Website you wish to allow to connect
	res.setHeader('Access-Control-Allow-Origin', 'https://syntics.co');
